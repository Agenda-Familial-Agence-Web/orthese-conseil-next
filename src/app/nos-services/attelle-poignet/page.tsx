...
export default function AttellePoignetPage() {
  return (
    <>
      <HeroBanner backgroundImage="/images/orthese-du-poignet.jpg" title="Attelle et orthèse du poignet" breadcrumbs={[{ label: 'Accueil', href: '/' }, { label: 'Services', href: '/nos-services' }, { label: 'Attelle du poignet' }]} />
