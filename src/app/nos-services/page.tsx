...
const services = [
  ...
  { title: 'Services pédiatriques', description: 'Nous avons la santé de vos enfants à cœur.', href: '/nos-services/services-pediatriques', image: "/images/Marie, l'orthésiste en consultation avec une cliente.jpg" },
